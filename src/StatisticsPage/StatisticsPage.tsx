...
const StatisticsPage = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="grid grid-rows-1 w-full grid-cols-3 gap-5 p-10">
                {renderStatistics.map((el) => (
                    <div
                        className="w-full relative overflow-y-hidden flex items-center flex-col h-[50vh] border-10 border-solid border-hover rounded-3xl bg-hover">
                        <div className="flex bg-hover p-3 min-h-20 rounded-t-2xl">
                            <h2 className="text-xl">
                                {el.name}
                            </h2>
                        </div>
                        <div className="absolute inset-0 top-20 pointer-events-none inset"></div>
