...
const Header = () => {
    ...
    return (
        <header
            className="bg-main flex px-5 sm:px-10 md:px-15 justify-between items-center h-15 relative gap-5 sm:gap-10 shadow-lg shadow-light-hover">
            <Link to='/' className='w-10 sm:w-15 bg-gray-300 rounded-2xl p-1'>
                <img src='./image.png' alt='логотип'/>
            </Link>
            <Link to="/" className="absolute left-[calc(50%_-_55px)] md:left-[calc(50%_-_100px)] top-3"><h2
